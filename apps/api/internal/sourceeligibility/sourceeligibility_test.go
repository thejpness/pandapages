...
func eligibleHumanEvidence() HumanUKEvidence {
	...
	return HumanUKEvidence{WorkCategory: copyrighteligibility.WorkCategoryOrdinaryLiterary, WorkCategoryReferences: ref("Ordinary literary work"), FirstPublication: copyrighteligibility.PublicationEvidence{Year: 1865, References: ref("Published in 1865")}, Translation: copyrighteligibility.FactEvidence{State: copyrighteligibility.FactNoneConfirmed, References: ref("No translation in acquired text")}, AdditionalTextual: copyrighteligibility.FactEvidence{State: copyrighteligibility.FactNoneConfirmed, References: ref("No additional textual contribution")}, SpecialCategory: copyrighteligibility.FactEvidence{State: copyrighteligibility.FactNoneConfirmed, References: ref("No special category")}, UnpublishedAtEnd1988: copyrighteligibility.FactEvidence{State: copyrighteligibility.FactNoneConfirmed, References: ref("Published before 1988")}}
}
