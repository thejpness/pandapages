...
func (s *authTestStore) CreateProfile(
	...
	s.profileCreateReadingLevel = readingLevel
...
func (s *authTestStore) UpdateProfile(
	...
	s.profileUpdateReadingLevel = readingLevel
